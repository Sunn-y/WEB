...
<body>
	...
	<h2>REVIEW</h2>
	<hr width=40%>
	<form name="reviewForm" action="reviewEdit.do" method="post">
		<input type="hidden" name="md_num" value="${md_num}"> <input
			type="hidden" name="rv_num" value="${rv_num}">
		<table id="reviewTable" class="container" style="width: 40%">
			<tr>
				<td><label for="rv_md_star">평가 : </label> <input type="range"
					name="rv_md_star" min="0" max="5" value="${rVo.rv_md_star}"></td>
			</tr>
			<tr>
				<td><textarea name="rv_content"
						style="width: 100%; height: 100px;">${rVo.rv_content}</textarea></td>
			</tr>
		</table>
		<table class="container" style="width: 40%">
			<tr>
				<td align="right"><input type="submit" value="수정하기" class="BTN"
