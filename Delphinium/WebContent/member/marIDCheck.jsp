...
<body>
	...
	<form action="marIDCheck.do" name="idCheckForm" method="post">
		<table class="idCheckBox container">
			...
			<tr>
				<th style="font-size: 1.5em;" style="margin-top:0;">사업자등록번호<br></th>
			</tr>
			<tr>
