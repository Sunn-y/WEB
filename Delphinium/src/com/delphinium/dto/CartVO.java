...
public class CartVO {
	...
	public String toString() {
		return "CartVO [number=" + number + ", userID=" + userID + ", md_num=" + md_num + ", cname=" + cname
				+ ", md_name=" + md_name + ", md_price=" + md_price + ", md_sim_pic=" + md_sim_pic + ", qty=" + qty
				+ ", md_op1_name=" + md_op1_name + ", md_op2_name=" + md_op2_name + ", md_op3_name=" + md_op3_name
				+ ", md_op1_val=" + md_op1_val + ", md_op2_val=" + md_op2_val + ", md_op3_val=" + md_op3_val + "]";
	}
