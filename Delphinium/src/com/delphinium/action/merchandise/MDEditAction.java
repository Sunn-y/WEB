...
public class MDEditAction implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String md_num = multi.getParameter("md_num");
			...
			mdDao.mdEdit(mdVo, loginUser, md_num);

			MerchandiseVO mdVo2 = mdDao.mdInfo(loginUser, md_num);
			request.setAttribute("mdVo", mdVo2);
